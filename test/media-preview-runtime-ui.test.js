...
test("media preview runtime renders attachment summaries and file preview content", () => {
  const { runtime } = createRuntimeFixture();
  const uploadPath = "/Users/example/.codex-mobile-web/uploads/2026-07-01/thread-id/homeai-upload.jpg";
  ...
  assert.match(markdown, /data-protected-image-src="\/api\/files\/preview\/content\?threadId=thread-1&amp;path=%2FUsers%2Fexample%2F\.codex-mobile-web%2Fuploads%2F2026-07-01%2Fthread-id%2Fhomeai-upload\.jpg&amp;key=session-key"/);
...
test("media preview runtime keeps GitHub, Mermaid, and image view behavior local", () => {
  ...
  const imageHtml = runtime.renderImageView({
    type: "imageView",
    path: "/Users/example/.codex-mobile-web/uploads/2026-07-01/thread-id/generated.png",
