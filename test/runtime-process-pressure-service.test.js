...
test("runtime process pressure classifies production, stale hotfix, app-server, browser, and Spotlight", () => {
  const psText = [
    ...
    "26622 1 example 0.2 631248 03-19:12:27 Ss /runtime/node /prod/codex-mobile-web/codex-app-server-mux.js app-server --analytics-default-enabled",
    "26623 26622 example 50.7 3033504 03-19:12:27 R /Users/example/.local/bin/codex app-server --analytics-default-enabled",
    "30001 26623 example 0.0 102400 01-02:10:00 S /runtime/node/lib/node_modules/@colbymchenry/codegraph-darwin-arm64/node --liftoff-only codegraph.js serve --mcp",
    "30002 26623 example 0.0 35088 15:22:34 S /runtime/node scripts/codex-mobile-mcp-server.js --server http://127.0.0.1:8787 --key-file /private/key",
    "30003 26623 example 0.0 29952 15:22:34 S ./Codex Computer Use.app/Contents/SharedSupport/SkyComputerUseClient.app/Contents/MacOS/SkyComputerUseClient mcp",
    "30004 26623 example 0.0 8432 15:22:34 S /Applications/Codex.app/Contents/Resources/cua_node/bin/node_repl",
    "30005 26623 example 0.0 1040 01-03:18:19 S dns-sd -B _http._tcp local.",
    "30006 26623 example 0.0 1200 01-08:16:27 S /bin/zsh -c find /Users -maxdepth 5 -path '*codex-mobile-web*'",
    "78792 26623 example 17.7 1485472 13:58:26 Ss node server.js --key-file /private/key",
    "65827 1 example 0.0 214224 12:20:05 Ss /Applications/Google Chrome.app/Contents/MacOS/Google Chrome --user-data-dir=/tmp/codex-mobile-browser-self-check-IQufw5",
    "325 1 _mds_stores 6.9 1962848 06-16:04:25 Rs /System/Library/CoreServices/mds_stores",
  ].join("\n");
  const lsofText = [
    "COMMAND   PID USER   FD   TYPE DEVICE SIZE/OFF NODE NAME",
    "node    33840 example 20u  IPv4 0x1      0t0  TCP 127.0.0.1:8787 (LISTEN)",
    "node    78792 example 21u  IPv4 0x2      0t0  TCP 127.0.0.1:8788 (LISTEN)",
    "node    26622 example 22u  IPv4 0x3      0t0  TCP 127.0.0.1:54498 (LISTEN)",
  ].join("\n");
...
test("runtime process pressure flags production listener owner mismatch", () => {
  const psText = [
    "33840 1 example 1.0 204800 00:10:00 Ss /runtime/node server.js",
  ...
  assert.equal(result.issues[0].listenerUser, "example");
