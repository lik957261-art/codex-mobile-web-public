...
test("explicit Music permission repair target is not overridden by deploy lane text", () => {
  ...
  const plan = planHomeAiDeployLaneRouting({
    body,
    sourceThread: thread("music-source", "Music 06-23", "/Users/example/Documents/Music"),
  ...
  assert.equal(isRoutinePluginDeploymentRequest(body, thread("music-source", "Music 06-23", "/Users/example/Documents/Music")), false);
  assert.equal(plan.action, "allow");
