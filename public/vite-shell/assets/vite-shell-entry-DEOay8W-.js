...
var shell_asset_manifest_default = {
	...
	shellCacheName: "codex-mobile-shell-v628-ababf095eb24",
	clientBuildId: "0.1.12|codex-mobile-shell-v628-ababf095eb24",
	scriptAssets: [
...
var codexMobileViteEntryGroupLoaders = {
	"manifest": () => __vitePreload(() => import("./vite-entry-group-manifest-CUuu-8bC.js"), []),
	"foundation": () => __vitePreload(() => import("./vite-entry-group-foundation-D49aRGln.js"), []),
	"feature-runtimes": () => __vitePreload(() => import("./vite-entry-group-feature-runtimes-Bhy3hcBo.js"), []),
	"bootstrap-state": () => __vitePreload(() => import("./vite-entry-group-bootstrap-state-BFcFIF5q.js"), []),
	"shell-services": () => __vitePreload(() => import("./vite-entry-group-shell-services-B_1dk_n3.js"), []),
	"app-entry": () => __vitePreload(() => import("./vite-entry-group-app-entry-Bh346LHV.js"), [])
};
...
var esmCompatibilityImportPromise = __vitePreload(() => import("./_virtual_codex-mobile-esm-compatibility-DCHboihZ.js").then(async (module) => {
...
async function loadViteOwnedAppBootstrap(loaderPlan) {
	...
	if (!globalThis.CodexAppBootstrap || typeof globalThis.CodexAppBootstrap.createAppBootstrapRuntime !== "function") await __vitePreload(() => import("./app-bootstrap-BxCoMZL4.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), []);
...
var deferredEntryTopologyPromise = __vitePreload(() => import("./vite-deferred-entry-topology-B_830Xdo.js"), []);
