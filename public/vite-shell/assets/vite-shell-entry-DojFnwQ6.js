...
var _virtual_codex_mobile_shell_build_manifest_default = {
	...
	"shellCacheName": "codex-mobile-shell-v629-5e6fd9c4353e",
	"clientBuildId": "0.1.13|codex-mobile-shell-v629-5e6fd9c4353e",
	"classicShellCacheName": "codex-mobile-shell-v629-5e6fd9c4353e",
	"scriptAssets": [
...
var codexMobileViteEntryGroupLoaders = {
	"manifest": () => __vitePreload(() => import("./vite-entry-group-manifest-byWkQIHH.js"), []),
	"foundation": () => __vitePreload(() => import("./vite-entry-group-foundation-DbHrYpeD.js"), []),
	"feature-runtimes": () => __vitePreload(() => import("./vite-entry-group-feature-runtimes-Cv_tBXhS.js"), []),
	"bootstrap-state": () => __vitePreload(() => import("./vite-entry-group-bootstrap-state-DH2ZFpSK.js"), []),
	"shell-services": () => __vitePreload(() => import("./vite-entry-group-shell-services-BMwSfWHP.js"), []),
	"app-entry": () => __vitePreload(() => import("./vite-entry-group-app-entry-DYtrhBLF.js"), [])
};
...
var esmCompatibilityImportPromise = __vitePreload(() => import("./_virtual_codex-mobile-esm-compatibility-DS46ndUB.js").then(async (module) => {
...
async function loadViteOwnedAppBootstrap(loaderPlan) {
	...
	if (!globalThis.CodexAppBootstrap || typeof globalThis.CodexAppBootstrap.createAppBootstrapRuntime !== "function") await __vitePreload(() => import("./app-bootstrap-mqgYcqMW.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), []);
...
var deferredEntryTopologyPromise = __vitePreload(() => import("./vite-deferred-entry-topology-DiN0bMPA.js"), []);
